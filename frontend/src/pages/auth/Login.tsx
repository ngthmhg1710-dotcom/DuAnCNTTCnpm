...
// TDTU Student Activity Management Login Component (Restored Classic Design with Logo)
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-6">
          <div className="flex justify-center mb-3">
            <img src={logoImg} alt="TDTU Logo" className="h-20 w-auto object-contain drop-shadow-lg" />
          </div>
        ...
        {/* Main Auth Card (Classic White Antd Card) */}
        <Card
          ...
          {activeTab === 'google' && (
            <div className="mt-6 space-y-4">
              <div className="text-center px-1">
                <Typography.Text type="secondary" className="text-xs font-medium leading-relaxed">
